(function () {
    ...
    const formSchemas = [
        ...
        },
        {
            ...
            calculationNote: 'Sisa dihitung otomatis: persediaan warehouse ¢Ë†™ jumlah diberikan.',
            columns: [
                column('tanggal', 'Tanggal', 'date'),
        ...
        return `
            ...
            <section class="cm-catalog-panel">
                ...
                <div class="cm-material-strip">
                    ...
                    <span><i class="fa-solid fa-screwdriver-wrench"></i><strong>Cutting bit:</strong> ≤3 bit/HM  ·  ≤5 bit/1.000 m²</span>
            ...
            <div class="cm-inspection-grid">
                <article class="cm-card">
                    ...
                    <div class="cm-battery-visual ${status}">
                        <div class="cm-battery-terminal plus">+</div><div class="cm-battery-terminal minus">¢Ë†™</div>
            ...
            for (let pageNumber = 1; pageNumber <= pageTotal; pageNumber += 1) {
                ...
                try {
                    ...
                    const garbledRatio = nativeText
                        ? (nativeText.match(/[\uFFFDƒ¢ - ¡ƒ¯¿½]/g) || []).length / nativeText.length
                        : 1;
    ...
    function renderForecast() {
        ...
        panel.innerHTML = `
            ...
            <div class="pm-formula-strip" id="pmFormulaStrip">
                ...
                <div><strong>Selisih jatuh tempo</strong>Meter terkini ¢Ë†™ target service</div>
    ...
    function renderKitting() {
        ...
        panel.innerHTML = `
            ...
            <div class="pm-formula-strip">
                ...
                <div><strong>Shortage</strong>MAX(Qty required ¢Ë†™ stock yang dapat dialokasikan, 0)</div>
                <div><strong>Qty to order</strong>MAX(Shortage ¢Ë†™ on order, 0) setelah PN tervalidasi</div>
            </div>
        `;
                ...
                <div class="prod-tab-content active" id="tab-kpi-dash">
                    <div class="telemetry-status-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
                        <div class="telemetry-metric-item">
                            ...
                            <div class="telemetry-metric-footer">
                                <span style="font-size:0.72rem; color:var(--text-muted);">Target: ≥ 90.0%</span>
                            </div>
                        </div>
                        <div class="telemetry-metric-item">
                            <div class="telemetry-metric-header">
                            ...
                            <div class="telemetry-metric-footer">
                                <span style="font-size:0.72rem; color:var(--text-muted);">Target: ≥ 80.0%</span>
                            </div>
                        </div>
                        <div class="telemetry-metric-item">
                            <div class="telemetry-metric-header">
                            ...
                            <div class="telemetry-metric-footer">
                                <span style="font-size:0.72rem; color:var(--text-muted);">Target: ≤ 10.0%</span>
                            </div>
                        </div>
                        <div class="telemetry-metric-item">
                            <div class="telemetry-metric-header">
                    ...
                    <div class="telemetry-status-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); margin-top: -10px;">
                        <div class="telemetry-metric-item">
                            ...
                            <div class="telemetry-metric-footer">
                                <span style="font-size:0.72rem; color:var(--text-muted);">Target: ≥ 100 Jam</span>
                            </div>
                        </div>
                        <div class="telemetry-metric-item">
                            <div class="telemetry-metric-header">
                            ...
                            <div class="telemetry-metric-footer">
                                <span style="font-size:0.72rem; color:var(--text-muted);">Target: ≤ 6.0 Jam</span>
                            </div>
                        </div>
                    </div>
